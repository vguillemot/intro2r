...
![From Data to Viz : https://www.data-to-viz.com/](img/S04ggplot2/data-viz.png){width=50%}
...
![](img/S04ggplot2/ggplot.001.jpeg){width=100%}

## Les paramètres esthétiques {.center}

![](img/S04ggplot2/ggplot.002.jpeg){width=100%}

## Les géométries {.center}

![](img/S04ggplot2/ggplot.003.jpeg){width=100%}
...
fruits$SucresSup10 <- fruits$Sucres > 10
ggplot(***, 
     aes(***, 
     fill = SucresSup10)) +
   geom_***()
...
![Hadley Wickham](img/S04ggplot2/wickham.png){width=50%}
...
fruits$Eau2groupes <- cut(fruits$Eau, c(0, 84.2, 100))
ggplot(fruits, aes(Eau2groupes)) + 
...
dat.count <- with(fruits, 
  data.frame(
    groupe = sort(unique(groupe)), 
    Csup10 = tapply(VitamineC > 10, groupe, sum)))
...
Comment modifier les deux commandes précédentes pour faire un diagramme en bâtons montrant le nombre ayant une teneur en Eau supérieure à 80 g / 100 g par groupe ?
